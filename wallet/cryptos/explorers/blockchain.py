...
# utxo_url_2 = "%s/v1/btc/main/addrs/%s"
...
#     base_url = get_url_2(coin_symbol)
#     url = utxo_url_2 % (base_url, '|'.join(addrs))
#     response = requests.get(url)
#     if response.json()['final_balance'] == 0:
#         return []

#     try:
#         outputs = response.json()['txrefs']
